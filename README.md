...
Этот репозиторий предоставляет **универсальный reusable workflow** для GitHub Actions, который автоматизирует тестирование и деплой микросервисных приложений. Подключите его к любому репозиторию с микросервисами и настройте через простой YAML-конфиг!
...
- 🔄 Держите `ci-config.yml` актуальным при добавлении новых микросервисов
- 🌿 Используйте feature-ветки для тестирования перед мерджем в main
- 🐳 Тестируйте docker-compose локально перед пушем
- 🔐 Регулярно обновляйте SSH-ключи и токены

## 🤝 Вклад

Приветствуются PR с улучшениями! Откройте issue для обсуждения идей.

---

**Сделано с ❤️ для микросервисных команд**
